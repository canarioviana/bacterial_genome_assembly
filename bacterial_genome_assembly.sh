...
# Run FastQC
fastqc -t $(nproc) 1_reads/*.fq.gz -o 2_fastqc
# Deactivate Conda environment
conda activate base
...
conda activate fastqc
# Run FastQC
fastqc -t $(nproc) 3_fastp/*.fq.gz -o 4_fastqc
# Deactivate Conda environment
conda activate base
# Compress the output directory
...
# Unicycler (for prokaryotic genomes)
# Create an output directory
mkdir 5_unicycler
# Activate Conda environment
...
# Shovill (for prokaryotic genomes)
# Create an output directory
mkdir 5_shovill
# Activate Conda environment
